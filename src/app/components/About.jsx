...
const About = () => {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center bg-stone-50 px-6 py-24"
    >
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="space-y-4">
              <h2 className="text-stone-400 uppercase tracking-[0.4em] text-[10px] font-bold">
                About The Developer
              </h2>
              <h3 className="text-4xl md:text-5xl font-display font-medium text-stone-900 leading-[1.1] tracking-tight">
            ...
            <div className="flex items-center gap-2 text-stone-400 font-mono text-xs">
              ...
              <span>
                Based in{" "}
                <span className="text-stone-900">Jeddah, Saudi Arabia</span>
              </span>
            </div>
          ...
          >
            {/* Background Glow */}
            <div className="absolute inset-0 bg-amber-100/30 blur-3xl rounded-full" />
            ...
            <div className="relative w-full max-w-[320px] aspect-square">
              <motion.div
                ...
                className="absolute inset-0 bg-white border border-stone-200 rounded-[2.5rem] shadow-sm p-10 flex flex-col justify-between"
              >
                ...
                {/* Footer: Status line */}
                <div className="flex justify-between items-center text-[10px] font-mono text-stone-300 tracking-widest uppercase">
                  <span>Build.01</span>
                  <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
                    <span className="text-stone-400">Success</span>
                  </div>
                </div>
              </motion.div>

              {/* Simple subtle ring decoration */}
              <div className="absolute -inset-4 border border-stone-100 rounded-[3rem] pointer-events-none" />
            </div>
          </motion.div>
        </div>
      </div>
