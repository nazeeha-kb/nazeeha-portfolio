    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 bg-stone-50 dark:bg-stone-900 overflow-hidden">
      ...
      <div className="relative max-w-3xl text-center space-y-8">
        ...
        <motion.p
          ...
          className="text-stone-500 dark:text-stone-400 uppercase tracking-[0.35em] text-[11px] font-semibold"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-medium text-stone-900 dark:text-stone-100 leading-[1.1] tracking-tight"
        >
          Building{" "}
